...
function isEmail(input, params) {
    ...
    if (parts === null)
        return (false);
    if (!isValidLocalPart(parts.local, (params === null || params === void 0 ? void 0 : params.allowQuotedString) || false))
        return (false);
    if (!isValidDomainPart(parts.domain, (params === null || params === void 0 ? void 0 : params.allowAddressLiteral) || false))
        return (false);
    return (true);
}
