...
export declare const formatNatives: {
    ...
    struct: {
        defaultCriteria: {};
        mount?(chunk: import("../services").MountingChunk, criteria: import("./struct/types").StructSetableCriteria<keyof import("./types").FormatClassicTypes<keyof import("./types").FormatClassicTypes<any>>>): void;
        check(chunk: import("../services").CheckingChunk, criteria: StaticDefaultCriteria & Omit<import("./struct/types").StructSetableCriteria<keyof import("./types").FormatClassicTypes<keyof import("./types").FormatClassicTypes<any>>>, keyof import("./struct/types").StructMountedCriteria<import("./struct/types").StructSetableCriteria<keyof import("./types").FormatClassicTypes<keyof import("./types").FormatClassicTypes<any>>>>> & import("./struct/types").StructMountedCriteria<import("./struct/types").StructSetableCriteria<keyof import("./types").FormatClassicTypes<keyof import("./types").FormatClassicTypes<any>>>> & import("./types").StaticMountedCriteria, value: unknown): import("../services").CheckingReject["code"] | null;
    };
    number: {
        defaultCriteria: {};
