...
export interface NumberClassicTypes extends ClassicTypesTemplate<NumberSetableCriteria, {}> {
}
...
export interface NumberGenericTypes<T extends NumberSetableCriteria> extends GenericTypesTemplate<{}, NumberGuardedCriteria<T>> {
}
export {};
