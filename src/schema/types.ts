...
export type SchemaTreeNodeFormat = {
	format: FormatsInstance;// | FormatInstance[];
}

export type SchemaTreeNodeBranch =
  | { branchType: "entry"; branch: Record<string, SchemaTreeNode> }
  | { branchType: "array"; branch: Array<SchemaTreeNode> }
  | { branchType: "onely"; branch: SchemaTreeNode }
  | { branchType: "empty"; branch: null };
